<?php include("header.html"); ?>
    ...
    <p>
      TC18 is chaired by
    <dl>
      <dd> Chair: <a href="https://members.loria.fr/BKerautret">Bertrand Kerautret</a> - LORIA, Université of Lorraine - Nancy, France    
      <dd> Vice-Chair: <a href="http://www.cs.rug.nl/~michael">Michael Wilkinson</a> - University of Groningen, - Nederland    
    </dl>
    </p>
    <p> Board members:
      <dl>
        <dd>
          <a href="http://www.iiests.ac.in/index.php/it-abiswas" > Arindam Biswas</a> IIEST, Indian Institute of Engineering Science and Technology, Shibpur, India
        <dd>
          <a href="http://www.dimai.unifi.it/p-doc2-2016-200049-F-3f2b342a362f2d-0.html"> Andrea Frosini </a> Dept. Matematica and Informatica <a href="http://www.dimai.unifi.it/">"Ulisse Dini"</a>, Firenze, Italia 
        <dd>
          <a href = "https://sites.google.com/site/georgiosouzounis/home" > Georgios K Ouzounis </a> DigitalGlobe, Inc.   Longmont, CO 80503, USA 
        <dd>
    ...
    <p>
      ...
      past organisation:
     <dl>
      <dd>  <a href="http://www.gipsa-lab.fr/~isabelle.sivignon/">Isabelle Sivignon</a> - GIPSA-lab, CNRS - Grenoble, France  - Chair    
      <dd>  <a href="http://www.facweb.iitkgp.ernet.in/~pb/">Partha Bhowmick</a> - Department of Computer Science and Engineering, Indian Institute of Technology - Kharagpur, India - Vice-chair
      <dd>  <a href="http://ma1.eii.us.es/miembros/rogodi/">Rocio Gonzalez-Diaz</a> - Applied Math Department School of Computer Engineering - University of Seville, Spain - Vice-chair
 
	<dd> <a href="http://hci.iwr.uni-heidelberg.de/people/ukoethe/">Ullrich Koethe</a> - Heidelberg Collaboratory for Image Processin g - Heidelberg, Germany - Former Chair 
	  
      <dd> <a href="http://visielab.ua.ac.be/staff/batenburg/">Joost Batenburg</a> - Vision Lab - Wilrijk, Belgium - Former Vice-Chair
      <dd> <a href="http://liris.cnrs.fr/guillaume.damiand/">Guillaume Damiand</a> - LIRIS Laboratory - Lyon, France - Former Vice-Chair

     <dd>  <a href="http://www.cs.fredonia.edu/barneva/">Reneta
	 Barneva</a> - State University of New York at Fredonia - Former Vice-Chair

     <dd>  <a href="http://liris.cnrs.fr/david.coeurjolly/">David
     Coeurjolly</a> - LIRIS Laboratory - Lyon, France - Former Chair      

     <dd><a href="http://www.tcs.auckland.ac.nz/~rklette/">Reinhard
     Klette</a> - Centre for Image Technology and Robotics (Computer
     Vision Unit), Auckland, New Zeeland - updating of the web page on <a href="http://www.citr.auckland.ac.nz/dgt/">Open problems</a>
     
       
     <dd>Annick Montanvert - LIS Laboratory - Grenoble, France - Former Chair
       
     <dd>  <a href="http://www.cb.uu.se/~ingela/English.html">Ingela
	 Nystr&ouml;m</a> - Centre for Image Analysis - Uppsala, Sweden - Former Chair
       
     <dd><a href="http://www.iut-arles.up.univ-mrs.fr/eremy/">Eric
	 Remy</a> - LSIS, Universit&eacute; de Provence, Arles, France - <a href="code_data_set/data_code.html">TC18 image and code data base</a>
       
     <dd>  <a href="http://www.cb.uu.se/~stina/index_eng.html">Stina
	 Svensson</a> - Centre for Image Analysis - Uppsala, Sweden - Former Vice-Chair
    </dl>
  </p>
...
Every year, the technical committee writes a report on its activities for the IAPR. Here are some reports of the last few years: <a href="files/reportIAPR2015.pdf">interim report 2014-2015</a> <a href="files/reportIAPR2014.pdf">report 2012-2014</a> <a href="files/reportIAPR2013.pdf">interim report 2013</a> <a href="files/reportIAPR2016.pdf">report 2014-2016</a>  <a href="files/reportIAPR2017.pdf">interim report 2016-2017</a>
    ...
    <p>
      During each <a href="events.html#dgci">DGCI</a> (Discrete Geometry for Computer Imagery - main conference for TC18), a TC meeting is held to give the possibility for the members to discuss the activity of the TC. 
    </p>
    ...
    <h2><a name="becomemember">How to become a member ?</a></h2>
    
    <p>Fill and send the following form:
      
    <FORM NAME="mail" ACTION="mailto:tc18@tc18.org?subject=TC18-member" METHOD="post" ENCTYPE ="text/plain" >
	...
	<tr>
      ...
      <p>
	address to your web page<br>
<INPUT type="text" name="@@yourweb" size="40">
</p>
      <p>
	address to the web page of your group<br>
<INPUT type="text" name="@@groupweb" size="40">
</p>

<p>
    Please, indicate also if you want to have an active role in TC18. What we have in mind so far is to find persons willing to collect information for and to update web pages containing
      <ul>
	<li> lists of reference literature.
	<li> documents on basic notions. This can be, for example, presentations used to give introductory lectures or seminars.
	<li> databases with reference images to be used for comparison between the performance for algorithms.
	<li> lists of open problems. For this one, we already have a link to the web page on open problems by Reinhard Klette.
      </ul>


<TEXTAREA name="@@webpage" rows="8" cols="60">
I want to help ...
</textarea>
...
<p>
      In case you have problems with the web based form, or to modify
      some information, or to unsubscribe, please send an email
      to  <a href="mailto:tc18@tc18.org">tc18 board</a>. To register,
...
address to the web page of your group:
active role:
</pre></p>
  
    <h2><a name="listmembers">List of members</a></h2>
